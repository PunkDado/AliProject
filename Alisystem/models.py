...
#from django.core.urlresolvers import reverse # Para possibilitar a manipulação de dados com forms - Obsoleto a partir do Django 2
...
class Procedimento(models.Model):
    ...
    tipo_procedimento = models.ForeignKey(Tipos_procedimento, blank = True, null = True, verbose_name = 'Tipo do procedimento', on_delete=models.CASCADE)
...
class Atendimento(models.Model):
	dentista = models.ForeignKey(Dentista, on_delete=models.CASCADE)
	paciente = models.ForeignKey(Paciente, on_delete=models.CASCADE)
	convenio = models.ForeignKey(Convenio, null=True, on_delete=models.CASCADE)
	forma_pagamento = models.ForeignKey(Formas_pagamento, blank=True, null=True, verbose_name = 'Forma de pagamento', on_delete=models.CASCADE)
...
class Procedimentos_aplicado(models.Model):
	...
	procedimento = models.ForeignKey(Procedimento, blank=True, null=True, help_text='Escolha o seu procedimento nesta lista, ou insira um novo procedimento clicando no sinal de +', on_delete=models.CASCADE) # Procedimentos padronizados a partir da tabela de preços
